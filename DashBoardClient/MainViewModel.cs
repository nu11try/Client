...
namespace DashBoardClient
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public string InfoCastMess(string message)
        {
        ...
        public void SuccCastMess(string message)
        {
            var options = new MessageOptions
            {
                FontSize = 15,
        ...
        public void ErrCastMess(string message)
        {
            var options = new MessageOptions
            {
                FontSize = 15,
        ...
        public void WarCastMess(string message)
        {
            var options = new MessageOptions
            {
                FontSize = 15,
